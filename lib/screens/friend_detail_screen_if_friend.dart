...
class FriendDetailScreenIfFriend extends StatelessWidget {
  static const routeName = '/friend-detail-screen-if-friend';

  @override
  Widget build(BuildContext context) {
    final routeArgs =
        ModalRoute.of(context).settings.arguments as Map<String, dynamic>;
    final friendUID = routeArgs['friendUID'];
                            ...
                            MaterialButton(
                                ...
                                onPressed: () {
                                  Navigator.of(context).pushNamed(ChatScreen.routeName,arguments: {
                                    ...
                                    'userDP':snapshot.data['profilePicture'],
                                  });
                                }),
                          ],
                        );
